...
public class BookingController {
	 ...
	 * @throws BookingNotFoundException
	 */
	@GetMapping("/cost/{bookingId}/{customerId}")
	public double TotalBookingost(@PathVariable int bookingId,@PathVariable int customerId)
			throws AccessForbiddenException, BookingNotFoundException {
		/*
		 * if (!loginController.loginStatus()) throw new
		 * AccessForbiddenException("Not Logged In/Invalid Loggin");
		...
		return bookingService.calculateTotalCost(bookingId,customerId);
	}
}
