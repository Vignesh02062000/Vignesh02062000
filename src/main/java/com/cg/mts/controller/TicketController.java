...
public class TicketController {
	 ...
	 */
	@PostMapping("/add")
	public ResponseEntity<Ticket> addATicket(@RequestBody Ticket ticket,@RequestParam(required = false) Integer bookingId,@RequestParam int customerId)
			throws AccessForbiddenException, TicketNotFoundException {
		
		ticket = ticketService.addTicket(ticket,bookingId,customerId);
